...
```
Ici, tout se passe bien si l'utilisateur entre un entier, mais si l'utilisateur envoie autre chose comme un mot, l'exception `NumberFormatException` sera invoquée. Afin de corriger cela, nous devrions faire :
```java
public class Main {
